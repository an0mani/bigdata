...
<body id="top">
	...
	<div id="main" style="margin-left: 380px;padding-top: 0px;padding-bottom: 50px;padding-left: 50px;padding-right: 0px;border-bottom-width: 100px;">
		...
		<div class="row">
			<article class="10u 16u$(xsmall) work-item"> <a
				href="images/fulls/analysis.jpg" class="image fit thumb"><img
				src="images/thumbs/analysis.jpg" alt="" /></a>
			<h1>유아질병에 관한 글(100~200자)<br>aaaaaaaaaaaaaaa</h1>
			<h1><p>질병순위Top10</p></h1>
			<h2>질병1: ㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇ</h2>
			</article>
