		...
		<div class="8u 12u$(small)">
			<form method="post" action="../messageboard" enctype="multipart/form-data">
				<div class="row uniform 50%">
					...
					<div class="6u$ 12u$(xsmall)">
						<input type="text" name="name" id="name" placeholder="name" style="font-family: 'a고래야놀자';color:black;" />
					</div>
					<div class="6u$ 12u$(xsmall)">
                  		<input type="date" name="date" id="date" style="font-family: 'a고래야놀자';color:black;" />
               		</div>
					<div class="6u$ 12u$(xsmall)">
