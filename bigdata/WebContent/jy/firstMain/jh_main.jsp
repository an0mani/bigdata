					...
					<c:otherwise>
						<div style="margin-right: 10%;">
							<a href="#banner" class="scrolly"
								style="color: black; font-weight: bold; font-size: 41px; font-family: 'a고래야놀자'; "><input type="button" value= "${Login_name }엄마의 육아일기 시작!" style="border-radius: 100%; font-family: 'a고래야놀자'; font-weight: bold; font-size: 31px; "></a>
						</div>
					</c:otherwise>
				</c:choose>
